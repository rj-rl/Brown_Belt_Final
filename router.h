...
private:
    ...
    // assign minimal weight to each edge in graph
    // including zero for all "vertex to itself" edges
...
// main work has already been done and the result stored in route_internal_data
// all BuildRoute does is it packs the info into RouteInfo, and it expands
// the shortest path into a vector<EdgeId>
template <typename Weight>
